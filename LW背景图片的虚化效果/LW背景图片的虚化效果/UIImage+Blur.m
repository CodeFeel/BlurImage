                ...
                completion:(void(^)(UIImage *blurImage))completion
{
    ...
    UIImage *blurImage = [self blurImageWithRadius:EffectBlurRadius tintColor:effectColor saturationDeltaFactor:EffectSaturationDeltaFactor maskImage:nil];
    if (completion) {
